...
uint16_t DENONAVR_MQTT_ON ;   //"DENONAVR_MQTT_ON"
uint16_t DENONAVR_MQTT_OFF ;   //"DENONAVR_MQTT_OFF"
uint16_t DENONAVR_MQTT_MUTE ;   //"DENONAVR_MQTT_MUTE"
uint16_t DENONAVR_MQTT_VOL_UP ;   //"DENONAVR_MQTT_VOL_UP"
uint16_t DENONAVR_MQTT_VOL_DOWN ;   //"DENONAVR_MQTT_VOL_DOWN"
uint16_t DENONAVR_MQTT_INPUT_BRAY ;   //"DENONAVR_MQTT_INPUT_BRAY"
uint16_t DENONAVR_MQTT_INPUT_PS5 ;   //"DENONAVR_MQTT_INPUT_PS5"
uint16_t DENONAVR_MQTT_INPUT_SWITCH ;   //"DENONAVR_MQTT_INPUT_SWITCH"
uint16_t DENONAVR_MQTT_INPUT_SHIELD ;   //"DENONAVR_MQTT_INPUT_SHIELD"
uint16_t DENONAVR_MQTT_SOUND_MODE_MOVIE ;   //"DENONAVR_MQTT_SOUND_MODE_MOVIE"
...
void register_device_denonAvr() {
  ...
  register_command(&DENONAVR_MQTT_ON , makeCommandData(MQTT, {"omote/denonavr", "avr_on"}));
  register_command(&DENONAVR_MQTT_OFF , makeCommandData(MQTT, {"omote/denonavr", "avr_off"}));
  register_command(&DENONAVR_MQTT_MUTE , makeCommandData(MQTT, {"omote/denonavr", "avr_mute"}));
  register_command(&DENONAVR_MQTT_VOL_UP , makeCommandData(MQTT, {"omote/denonavr", "avr_vol_up"}));
  register_command(&DENONAVR_MQTT_VOL_DOWN , makeCommandData(MQTT, {"omote/denonavr", "avr_vol_down"}));
  register_command(&DENONAVR_MQTT_INPUT_BRAY , makeCommandData(MQTT, {"omote/denonavr", "avr_input_bray"}));
  register_command(&DENONAVR_MQTT_INPUT_PS5 , makeCommandData(MQTT, {"omote/denonavr", "avr_input_ps5"}));
